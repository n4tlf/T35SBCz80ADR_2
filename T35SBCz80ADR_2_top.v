...
*   May 16,2023 TFOX: Updated signal names and added Data OUT bus drive *
************************************************************************/
module  T35SBCz80ADR_2_top (

    s100_n_RESET,        // reset to T35 board, active low
    pll0_LOCKED,
    pll0_2MHz,
    F_in_cdsb,
    F_in_sdsb,
    ...
    s100_SDSB,          // S100 Address buffer disable signal
...
assign S100adr16_19 = counter[20:17];   // Drive A16-19 from counter
assign s100_DO = counter[26:19];        // Drive the Data Out LEDs                                
...
/****************************************************************************
*       CREATE OR FAKE SEVERAL S100 SIGNALS TO ENABLE FRONT PANEL or BDB    *
****************************************************************************/
assign s100_sINTA = 0;
assign s100_n_sWO = 0;
assign s100_sMEMR = 0;
assign s100_sOUT = counter[20];
...
assign n_reset = s100_n_RESET;             // connect the CPU reset
...
always @(posedge pll0_2MHz)
    begin
        if(s100_n_RESET == 0) begin   // if reset set low...
